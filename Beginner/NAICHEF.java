...
public class NAICHEF{
	public static void main(String args[]){
		...
		while(t-->0){
            ...
            Map<Integer, Long> map = Arrays.stream(str).map(Integer::valueOf).collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));
            long countA = map.containsKey(a) ? map.get(a) : 0;
            long countB = map.containsKey(b) ? map.get(b) : 0;
			answer.add(countA * countB * 1.0000000d / (n*n));
		}
